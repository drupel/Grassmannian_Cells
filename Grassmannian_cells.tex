...
Alternatively, a cell decomposition of $X$ is a collection of disjoint subsets $U_1,\ldots,U_k\subset X$, each isomorphic to an affine space, such that each $X_i=U_1\sqcup\cdots\sqcup U_i$ is closed in $X$ with $X_k=X$.
We call the subsets $U_i$ the \emph{affine cells} for this cell decomposition.
