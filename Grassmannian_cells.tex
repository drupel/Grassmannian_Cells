...
This is obtained in Section~\ref{sec:fibrations} by combining a torus action on quiver Grassmannians which is introduced in Section~\ref{torusaction} and the Caldero-Chapoton map for short exact sequences of representations.
