...
\begin{remark}
  ...
  By Theorem~\ref{vb}, to establish cell decompositions for the $\cG_{\tbff,\tbfg}$ it suffices to find a cell decomposition of $\Gr_\tbff(M)\times\Gr_\tbfg(N)$ for which $\Im\big(\Psi_{\tbff,\tbfg}\big)$ is a union of affine cells.
\end{remark}
