...
Let $\tilde Q$ and $\tilde Q'$ be two equivalent $2$-quivers. A subset $\beta\subset Q_0$ is strong successor closed if and only of $\beta\subset Q_0'$ is strong successor closed.
In particular, the number of strong successor closed subsets of $Q_0$ coincides with the one of $ Q_0'$.
\end{lemma}
\begin{proof}
