...
\subsubsection*{Proof of Theorem~\ref{cellscover}}
  ...
  When $|J|<n-2$, we may find subsets $I,I'\subsetneq\{1,\ldots,n\}$ with $J\subsetneq I,I'$, $I\setminus J=\{j\}$, $I'\setminus J=\{j'\}$, and $j\ne j'$.
  This gives rise to the following commutative diagram:
  \[\xymatrix{& & 0\ar[d]& 0\ar[d]&\\
  ...
  Then for $\tilde E\in A$, writing $\tilde G'=\tilde\pi_{m+1}^{I',J}(\tilde E)$, we see $\tilde\pi_{m+1}^{I',J}(\tilde G')\in D$ and $\tilde G'\cap \tilde P_{m,j}\in B$.
