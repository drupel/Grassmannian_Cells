...
\begin{theorem}
  \label{cellscover}
  For $m\geq 1$ and $J\subsetneq\{1,\ldots,n\}$, every quiver Grassmannian $\Gr^{\tilde Q}_\tbfe(\tilde P_{m+1}^J)$ admits a cell decomposition.
\end{theorem}
\begin{corollary}
...
\end{proof}
\begin[Proof of Theorem~\ref{cellscover}]{proof}
