...
\begin{remark} \sayD{We need to change the conventions above to include notation for the equivalence between $\rep K(n)$ and $\rep K(n)^{op}$.}	\sayT{Changed it a bit}
