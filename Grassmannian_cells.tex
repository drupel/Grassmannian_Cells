...
Our goal is to give a geometric explanation for this by showing that the compatible pairs provide a natural labeling for the cells of $\chi\big(\Gr^Q_\bfe(P_m)\big)$ found in Theorem~\ref{celldec}.
...
\begin{theorem}
  ...
  Compatible pairs label cells in $\Gr_\bfe(P_m^V)$.
\end{theorem}
\begin{proof}
  ...
  This provides a bijection of these vertices with the edges of $D_m^{[r]}$ whereby vertices covering the vertex 1 (resp.\ vertex 2) of $K(n)$ correspond to horizontal edges (resp.\ vertical edges).
