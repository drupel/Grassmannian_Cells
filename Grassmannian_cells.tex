...
\begin{proof}
  ...
  But then Lemma~\ref{le:injective evaluation maps} implies $ev\circ\iota_{m-1}=ev_V\circ\iota_{m-1}\ne0$, a contradiction.\sayT{why does this imply that $\iota_{m-1}=0$? This should contradict the fact that \eqref{eq:AR sequence} is an AR-sequence.}\sayD{is this better?}
