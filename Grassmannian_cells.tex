...
\noindent {\bf Claim.} Every quiver Grassmannian $\Gr^{\tilde Q}_\tbfe(\tilde P_{m}^{(k-1)})$ has a cell decomposition which is compatible with a fixed quotient map $\pi_m^{\bf j}$ in the following way: 
