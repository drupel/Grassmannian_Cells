...
\begin{proof}
  ...
  whereas $P_{m+1}^V$ is not preprojective.\sayT{The proof as written seems to be false as $\Hom(X,P_\ell)\ne0$ does not imply $\Hom(Y,P_\ell)\neq 0$ for all direct summands $Y$ of $X$. The easiest way would be to reorganize 3.8-3.10 in such way that we can assume that $X=P_m^V$ is indecomposable.}
