...
\begin{proof}
  ...
  This shows the first statement.
	  ...
	  By Lemma~\ref{le:unique morphisms}, the endomorphism ring of $P_{m+1}^V$ is one-dimensional and so $P_{m+1}^V$ must be indecomposable. As both, the isomorphism classes of indecomposables and the isomorphism classes of truncated projectives of dimension $d(m,r)$, are parametrized by the same Grassmannian, this gives the second claim.
